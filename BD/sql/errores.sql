...
/* 3 - profesionales */
insert into errores values (300, 'Login ya existe como profesional', 0)
insert into errores values (301, 'El profesional a actualizar no existe', 0)

/* 4 - clientes */
insert into errores values (400, 'Login ya existe como cliente', 0)
...
insert into errores values (503, 'La solicitud a acutalizar no existe', 0)
